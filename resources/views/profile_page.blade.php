            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="text-center">
                      {{-- <img class="borCircle mt-3 mb-3" width="180rem" src="" alt=""> --}}
                      <img class="borCircle mt-3 mb-3" width="180rem" src="{{ asset($profile->image_path) }}" alt="Profile Image">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="mt-5">
                      <ul>
                          ...
                          <li class="mb-3 mt-1 list-d-n"><p>{{ $profile->deskripsi }}</p></li>
                          <li class="mt-1 list-d-n fc-abu"><p>{{ $profile->agama }}</p></li>
                          <li class="mt-1 list-d-n fc-abu"><p>{{ $alamat->kota }}, {{ $alamat->provinsi }}</p></li>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-5 bg-light riwayatPendidikan">
            ...
            <hr>
            <ul>
              <li class="mt-1 list-d-n"><h3>{{ $pendidikan->nama_sekolah }}</h3></li>
              {{-- <li class="mb-3 mt-1 list-d-n fc-abu"><h6>Rekayasa Perangkat Lunak</h6></li> --}}
              <li class="mb-3 mt-1 list-d-n fc-abu"><h6>{{ $pendidikan->lokasi }}</h6></li>
              <li class="mb-3 mt-1 list-d-n fc-abu"><h6>{{ $pendidikan->tanggal_masuk }} | {{ $pendidikan->tanggal_lulus }}</h6></li>
            </ul>
            {{-- <ul>
          ...
          <div class="col-md-5 bg-light Organisasi ms-1 ">
            <h2 class="mt-2 mb-1">RIWAYAT PEKERJAAN</h2>
            <hr>
            <ul>
              <li class="mt-1 list-d-n"><h3>{{ $pekerjaan->nama_perusahaan}}</h3></li>
              <li class="mb-3 mt-1 list-d-n fc-abu"><p>{{ $pekerjaan->posisi}}</p></li>
              <li class="mb-3 mt-1 list-d-n fc-abu"><h6>{{ $pekerjaan->lokasi}}</h6></li>
              <li class="mb-3 mt-1 list-d-n fc-abu"><h6>{{ $pekerjaan->tanggal_masuk_kerja}} | {{ $pekerjaan->tanggal_keluar_kerja}}</h6></li>
            </ul>
          </div>
          <div class="col-md-1 bgc-abu2"></div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-10 bg-light Organisasi">
                <h2 class="mt-2 mb-1">SKILL</h2>
                <hr>
                <ul>
                  <li class="mt-1 list-d-n"><h3>{{ $skill->nama_skill}}</h3></li>
                  {{-- <li class="mb-3 mt-1 list-d-n fc-abu"><h6>Ketua Osis</h6></li> --}}
                  {{-- <li class="mb-3 mt-1 list-d-n fc-abu"><h6>2019-2022</h6></li> --}}
                  <li class="mb-3 mt-1 list-d-n fc-abu"><p>{{ $skill->deskripsi_skill}}</p></li>
