...
<body>
    ...
    <div class="container mb-3">
        <h2 class="text-center" style="margin-top: 50px;" >Edit Data Diri</h2>
        <div class="mb-5"></div>
        {{-- @extends('layouts.app') --}}
        ...
        <div class="container">
            <form action="{{ route('profile.update', ['id' => $profile->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Tambahkan input untuk data profil -->
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <script>
                    document.getElementById("inputProfileDeskripsi").value="{{ $profile->deskripsi }}";
                </script>
            </div>            
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="inputTempatLahir" class="form-control" aria-describedby="passwordHelpInline" name="tempat_lahir" value="{{ $profile->tempat_lahir }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="date" id="inputTanggalLahir" class="form-control" aria-describedby="passwordHelpInline" name="tanggal_lahir" value="{{ $profile->tanggal_lahir }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <select class="form-select" name="agama" aria-label="Agama">
                        <option value="" {{ $profile->agama == '' ? 'selected' : '' }}>Pilih Agama</option>
            ...
            <div class="row g-3 align-items-center mb-3">
              ...
              <div class="col-md-3">
                  <select id="kota" name="kota" class="form-select" aria-label="Kab/Kota">
                      <option value="{{ $alamat->kota }}">{{ $alamat->kota }}</option>
                  </select>
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
              ...
              <div class="col-md-3">
                <select id="kelurahan" name="kelurahan" class="form-select" aria-label="Kecamatan">
                    <option value="{{ $alamat->kelurahan }}">{{ $alamat->kelurahan }} </option>
                </select>
              </div>
            ...
            <div class="row g-3 align-items-center mb-3">
              ...
              <div class="col-md-6">
                  <input type="text" name="dusun" id="dusun" class="form-control" aria-describedby="passwordHelpInline" placeholder="Dusun" value="{{ $alamat->dusun }}">
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
              ...
              <div class="col-md-6">
                  <input type="text" id="KodePos" class="form-control" name="poscode" pattern="[0-9]{5}" placeholder="Contoh: 12345" oninput="this.value = this.value.replace(/[^0-9-]/g, '');" value="{{ $alamat->poscode }}">
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
              ...
              <div class="col-md-6">
                  <input type="tel" id="NomorTelepon" class="form-control" name="no_telepon" pattern="[0-9{12}" placeholder="Contoh: 082245981890" oninput="this.value = this.value.replace(/[^0-9-]/g, '');" value="{{ $profile->no_telepon }}">
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
              ...
              <div class="col-md-6">
                  <input type="email" id="inputNama" class="form-control" name="email" aria-describedby="passwordHelpInline" placeholder="name@contoh.com" value="{{ $profile->email }}">
              </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="nama_sekolah" name="nama_sekolah" aria-label="Nama_sekolah" class="form-control" value="{{ $pendidikan->nama_sekolah }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="lokasi" name="lokasi" aria-label="Lokasi" class="form-control" value="{{ $pendidikan->lokasi }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-3 ">
                    <p>Tanggal Masuk</p>
                    <input type="date" id="inputTanggalMasuk" name="tanggal_mulai" class="form-control" value="{{ $pendidikan->tanggal_masuk }}">
                </div>
                <div class="col-md-3">
                    <p>Tanggal Lulus</p>
                    <input type="date" id="inputTanggalLulus" name="tanggal_lulus" class="form-control" value="{{ $pendidikan->tanggal_lulus }}">
                </div>
            </div>  
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="nama_perusahaan" name="nama_perusahaan" aria-label="Nama_perusahaan" class="form-control" value="{{ $pekerjaan->nama_perusahaan }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="posisi" name="posisi" aria-label="Posisi" class="form-control" value="{{ $pekerjaan->posisi }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="lokasi" name="lokasi" aria-label="Lokasi" class="form-control" value="{{ $pekerjaan->lokasi }}">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-3 ">
                    <p>Tanggal Masuk</p>
                    <input type="date" id="inputTanggalMasukkerja" name="tanggal_mulai_kerja" class="form-control" value="{{ $pekerjaan->tanggal_masuk_kerja }}">
                </div>
                <div class="col-md-3">
                    <p>Tanggal Keluar</p>
                    <input type="date" id="inputTanggalKeluaarKerja" name="tanggal_keluar_kerja" class="form-control" value="{{ $pekerjaan->tanggal_keluar_kerja }}">
                </div>
            </div>  
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" id="nama_skill" name="nama_skill" aria-label="Nama_skill" class="form-control" value="{{ $skill->nama_skill }}">
                </div>
            </div>
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3">
                ...
                <script>
                    document.getElementById("inputDeskripsiSkill").value="{{ $skill->deskripsi_skill }}";
                </script>
            </div> 
            <div class="mb-4" style="margin-top: 20px;"></div>
            {{-- <div class="row ">
